...
# ファイルパスをリストで指定
file_paths = [
    "sk398_005_bta_0-completed.db_median_fluo_intensities.csv",  # 最初のファイル
    "sk398_005_bta_07-completed.db_median_fluo_intensities.csv",  # 残りの5つのファイル
    "sk398_005_bta_1-completed.db_median_fluo_intensities.csv",
    "sk398_005_bta_13-completed.db_median_fluo_intensities.csv",
    "sk398_005_bta_15004-completed.db_median_fluo_intensities.csv",
    "sk398_005_bta_18-completed.db_median_fluo_intensities.csv"
]
