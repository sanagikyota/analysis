...
file_paths = [
    "398_bta_0exp001-completed.db_median_fluo_intensities.csv",  # 最初のファイル
    "398_bta_1001-completed.db_median_fluo_intensities.csv",
    "398_bta_13001-completed.db_median_fluo_intensities.csv",
    "398_bta_15002-completed.db_median_fluo_intensities.csv"
]
