...
# ファイルパスをリストで指定
file_paths = [
    "sk25_pgro7ara200_bta_0-completed.db_median_fluo_intensities.csv",  # 最初のファイル
    "sk25_pgro7ara200_bta_07-completed.db_median_fluo_intensities.csv",  # 残りの3つのファイル
    "sk25_pgro7ara200_bta_1-completed.db_median_fluo_intensities.csv",
    "sk25_pgro7ara200_bta_13-completed.db_median_fluo_intensities.csv"
]
