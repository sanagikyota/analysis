...
# ファイルパスをリストで指定
file_paths = [
    "sk25_bta_0002-completed.db_median_fluo_intensities.csv",  # 最初のファイル
    "sk25_bta_07-completed.db_median_fluo_intensities.csv",  # 残りの3つのファイル
    "sk25_bta_10-completed.db_median_fluo_intensities.csv",
    "sk25_bta_13-completed.db_median_fluo_intensities.csv"
]
