...
meds_5 = []
with open('sk402_005_bta_18_meds.txt') as f:
    for i in f.readlines():
        meds_5.append(float(i.split(',')[0]))
meds_6 = []
with open('sk402_01_bta_18_meds.txt') as f:
    for i in f.readlines():
        meds_6.append(float(i.split(',')[0]))
meds_7 = []
with open('sk402_bta_18001_meds.txt') as f:
    for i in f.readlines():
        meds_7.append(float(i.split(',')[0]))
meds_8 = []
with open('sk398_bta_18001_meds.txt') as f:
    for i in f.readlines():
