...
file_paths = [
    "sk398_bta_0002-completed.db_median_fluo_intensities.csv",  # 最初のファイル
    "sk398_bta_07001-completed.db_median_fluo_intensities.csv",
    "sk398_bta_10001-completed.db_median_fluo_intensities.csv",
    "sk398_bta_15-completed.db_median_fluo_intensities.csv"
]
