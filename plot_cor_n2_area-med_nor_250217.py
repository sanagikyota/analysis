...
db_files = ["sqlite:///sk402_01_bta_0001-completed.db", "sqlite:///SK402_01_bta_0001-completed(2).db"]
csv_files = ["sk402_01_bta_0001-completed.db_median_fluo_intensities (1).csv", "SK402_01_bta_0001-completed.db_median_fluo_intensities (2).csv"]
...
scatter_plot.legend(handles=handles, labels=['sk402_canny40', 'sk402',], loc='lower right', fontsize=15)
...
plt.savefig("fig_plot_cor_402n2_area-med_250217.png")
plt.show()