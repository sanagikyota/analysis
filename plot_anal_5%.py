...
file_list = [
    ...
    "sk398_01_bta_exp-completed.db_median_fluo_intensities.csv",
    "sk402_01_bta_0001-completed.db_median_fluo_intensities.csv",
    "sk402_01_bta_exp-completed.db_median_fluo_intensities.csv",
]
...
plt.tight_layout()
plt.savefig("fig_5th_percentile_comparison_241217.png")
