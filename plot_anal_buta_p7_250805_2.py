...
file_paths = [
    "p7_bta_1_0805-completed.db_median_fluo_intensities.csv",
    "p7_bta_13_0805-completed.db_median_fluo_intensities.csv",
    "p7_bta_15_0805-completed.db_median_fluo_intensities.csv",
    "p7_bta_18_0805-completed.db_median_fluo_intensities.csv"
]
...
for i, file_path in enumerate(file_paths[1:], start=2):
    ...
    count_below_threshold = (numeric_data < 0.7404).sum().sum()
...
values = [0.05] + ratios
plot_labels = ['1.0', '1.3', '1.5', '1.8']  # 必要なら変更可（values と長さを合わせること）
...
# 保存と表示
outfile = 'p7_barplot_250805_2.png'
